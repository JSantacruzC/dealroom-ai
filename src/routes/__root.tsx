...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "DealRoom Orchestrator" },
      { property: "og:description", content: "Turn any ICP company into a ready-to-execute sales war room in under 30 seconds." },
